    ...
    <Dialog header="Add Save" v-model:visible="addSaveModal" @hide="resetForm" :modal="true" :draggable="false" class="w-5">
            ...
            <form method="POST" id='addForm' @submit.prevent="newSaveAdded(!v$.$invalid)">
                <div class="field">
                    <div class="p-float-label mt-4 field">
                        <InputText class="w-full" id="saveName" type="text" :disabled="submitted" v-model="v$.saveName.$model" autofocus :class="{'p-invalid':v$.saveName.$invalid && submitted}"/>
                ...
                <div class="p-float-label mt-4 field">
                    <InputText class="w-full"  id="managerName" type="text" :disabled="submitted" v-model="v$.managerName.$model" :class="{'p-invalid':v$.managerName.$invalid && submitted}" />
                ...
                <div class="field mt-4" >
                    ...
                    <Dropdown class="w-full" v-model="v$.gameVersion.$model" id="gVersion" :disabled="submitted" :options="versions" optionLabel="name" optionValue="name" placeholder="Select Game Version" :class="{'p-invalid':v$.gameVersion.$invalid && submitted}"/>
            ...
            <template #footer >
                <div class="flex align-content-center justify-content-center">
                    <Button label="Cancel" id="cancelB" :disabled="submitted" class='p-button-text' @click="closeAddSave" />
                    <Button label="Add" id="submitB" :disabled="submitted" type="submit" form="addForm"/>
                </div>
